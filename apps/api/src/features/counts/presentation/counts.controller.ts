...
export class CountsController{
  ...
  @Post()
  create(@Req() request:{auth:{userId:string;tenantId:string;role:string}},@Body() body:{inventoryId?:string;name?:string;location?:string;rounds?:CountRoundName[]}){
    ...
    return this.repository.create(request.auth.tenantId,body.inventoryId,body.name.trim(),body.location.trim(),rounds);
  }
